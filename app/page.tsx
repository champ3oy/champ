...
const Button = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className='cursor-pointer w-32 h-12 rounded-full flex items-center justify-center glass-button-shadow font-bold runde-medium'>
      <p>{children}</p>
    </div>
  )
}
...
const ContactButton = () => {
  return (
    <div className='cursor-pointer w-32 h-12 rounded-full flex items-center justify-center text-black/70 font-bold runde-medium'>
      <p>Contact</p>
    </div>
  )
}
  ...
  return (
    <div className='w-full'>
      <div className='w-full h-full background-gradient'>
        <div className='flex flex-col max-w-md mx-auto pt-36 '>
          <text className='text-6xl font-bold'>👋</text>
          <h1 className='text-5xl font-bold runde-bold text-black'>Hello, I'm ccc</h1>
        ...
        <div className='mt-20 overflow-hidden'>
          <div className='flex animate-scroll'>
            ...
            {Array.from({ length: 20 }).map((_, index) => (
              <div key={`first-${index}`} className='min-w-52 h-52 bg-red-500 rounded-3xl flex-shrink-0 mx-5'></div>
            ))}
            {/* Duplicate set for seamless loop */}
            {Array.from({ length: 20 }).map((_, index) => (
              <div key={`second-${index}`} className='min-w-52 h-52 bg-red-500 rounded-3xl flex-shrink-0 mx-5'></div>
            ))}
          </div>
        </div>

        <div className='flex flex-col max-w-lg mx-auto pt-36 '>
        ...
        {/* Experience Section */}
        <div className='flex flex-col max-w-lg mx-auto pt-36 pb-20'>
        ...
        <div className='flex flex-col max-w-lg mx-auto pt-36 pb-20'>
          ...
          <div className='flex flex-row gap-4 mt-10'>
            {/* copyright */}
            <p className='text-sm runde-medium text-black/70'>© 2025 ccc. All rights reserved.</p>
          </div>
        </div>
