...
const experience = [
  {
    ...
    description:
      "Crafting a modern investment platform tailored for Africa, making investing simpler, smarter, and more accessible.",
  },
  {
    ...
    description:
      "Dreaming up and building playful, useful apps that help people connect, learn, and enjoy the internet a little more.",
  },
  {
    title: "BeSocial",
    company: "Software Engineer",
    duration: "2020 - 2024",
    description:
      "Brought ideas to life across a suite of apps from social networking to shopping all under the BeSocial umbrella.",
  },
];
...
const featuredOpenSource = [
  ...
  },
  {
    ...
    description:
      "MobileView is a VSCode extension that helps you view your website on different devices and screen sizes.",
  },
  {
    name: "rodin",
    link: "https://github.com/champ3oy/rodin",
    description:
      "Rodin is an uptime monitoring tool that helps you monitor your website and services.",
  },
];
  ...
  return (
    <div className="flex flex-col">
      ...
      <Link
        href={link}
        target="_blank"
        className="text-sm runde-medium text-black/50"
      >
        {link}
      </Link>
...
const Button = ({ children }: { children: React.ReactNode }) => {
  return (
    <Link
      href="/resume.pdf"
      className="cursor-pointer w-32 h-12 rounded-full flex items-center justify-center glass-button-shadow font-bold runde-medium"
    >
      <p>{children}</p>
    </Link>
  );
...
const ContactButton = () => {
  return (
    <Link
      href="mailto:akotosel6@gmail.com"
      className="cursor-pointer w-32 h-12 rounded-full flex items-center justify-center text-black/70 font-bold runde-medium"
    >
      <p>Contact</p>
    </Link>
  );
      ...
      <div className="w-full h-full background-gradient">
            ...
            <div className="flex animate-scroll">
              ...
              {apps?.map((app, index) => (
                <Link
                  ...
                  target="_blank"
                  key={`first-${index}`}
                  className="flex-shrink-0 mx-3 flex flex-col items-center justify-center"
                >
                  <img
                    src={app.logo}
                    alt={app.name}
                  ...
                  />
                  <p className="text-sm runde-medium text-black/70 mt-2">
                    {app.name}
                  </p>
                </Link>
              ))}
        ...
        <div className="flex flex-col w-full md:max-w-md mx-auto pt-36 px-8 md:px-0 pt-36 pb-20">
          <div className="text-start mb-16">
            ...
            <h2 className="text-5xl font-bold runde-bold text-black mb-4">
              My professional journey in product development
            </h2>
          </div>
        ...
        <div className="flex flex-col w-full md:max-w-md mx-auto pt-36 px-8 md:px-0 pt-36 pb-20">
          ...
          <div className="flex flex-row gap-4 mt-10">
            {/* copyright */}
            <p className="text-sm runde-medium text-black/70">
              © 2025 cirlorm.dev. All rights reserved.
            </p>
          </div>
        </div>
      </div>
